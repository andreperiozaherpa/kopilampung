...
class Chat {
    ...
    constructor(options = {}) {
        ...
        Helpers.FetchJSON(Helpers.UrlFix("/assets/json/chat.json"), (data) => {
    ...
    _addListeners() {
        ...
        document.getElementById("chatAttachmentInput") &&
            document
                ...
                .addEventListener(
                    "change",
                    this._onAttachmentChange.bind(this)
                );
    ...
    _renderContact(contact, container) {
        ...
        itemClone
            ...
            .setAttribute("src", contact.thumb);
        if (contact.status !== "Online") {
            itemClone.querySelector("#contactStatus").classList.add("d-none");
        }
        if (contact.unread > 0) {
            itemClone.querySelector("#contactUnread").innerHTML =
                contact.unread;
            itemClone
                .querySelector("#contactUnread")
    ...
    _renderContactTitle() {
        ...
        contactTitle.querySelector(".name").innerHTML =
            this.currentChatData.name;
        contactTitle.querySelector(".last").innerHTML =
            this.currentChatData.last;
        contactTitle
            .querySelector(".profile")
            .setAttribute("src", this.currentChatData.thumb);
    ...
    _initScrollbars() {
        if (typeof OverlayScrollbars !== "undefined") {
            ...
            this.chatContentScroll = OverlayScrollbars(
