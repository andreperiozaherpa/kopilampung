    ...
    static CenterTextPluginSmall() {
        return {
            ...
            beforeDraw: function (chart) {
                ...
                activePercentage = parseFloat(
                    (activePercentage * 100).toFixed(1)
                );
                ctx.font = "12px" + Globals.font;
                ctx.textBaseline = "middle";
        ...
        const tooltips = {
            ...
            custom: function (tooltip) {
                ...
                if (tooltip.body) {
                    ...
                    container.querySelector(".text").innerHTML =
                        chart._data.labels[index].toLocaleUpperCase();
                    container.querySelector(".value").innerHTML =
                        Helpers.AddCommas(
            ...
            Chart.controllers.doughnutSmall = Chart.controllers.doughnut.extend(
                {
                    draw: function (ease) {
                        ...
                        var firstSegment =
                            this.chart.getDatasetMeta(0).data[0]._model;
                        var gap =
                            ((firstSegment.outerRadius -
                                firstSegment.innerRadius) *
                                (1 - 0.3)) /
                            2;
                        ctx.save();
                ...
                options: {
                    ...
                    legendCallback: function (chart) {
                        ...
                        itemClone.querySelector(".text").innerHTML =
                            chart.data.labels[0].toLocaleUpperCase();
