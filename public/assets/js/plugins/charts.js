    ...
    _initEvents() {
        ...
        document.documentElement.addEventListener(
            ...
            (event) => {
                ...
                // this._dashboardDonat && this._dashboardDonat.destroy();
                this._initSmallDoughnutCharts();
                    ...
                    tooltips: {
                        ...
                        custom: function (tooltip) {
                            ...
                            if (tooltip.body) {
                                ...
                                icon.setAttribute(
                                    "data-acorn-icon",
                                    chart._data.icons[index]
                                );
                                new AcornIcons().replace();
                                var iconContainer =
                                    tooltipEl.querySelector(".icon-container");
                                iconContainer.style =
                                    "border-color: " +
                                    tooltip.labelColors[0].borderColor +
                                    "!important";
                    ...
                    tooltips: {
                        ...
                        custom: function (tooltip) {
                            ...
                            if (tooltip.body) {
                                ...
                                new AcornIcons().replace();
                                tooltipEl.querySelector(".text").innerHTML =
                                    chart._data.datasets[
                                        datasetIndex
                                    ].label.toLocaleUpperCase();
                                tooltipEl.querySelector(".value").innerHTML =
                                    chart._data.datasets[datasetIndex].data[
                                        index
                                    ];
                            }
                            var positionY = this._chart.canvas.offsetTop;
                ...
                options: {
                    ...
                    legendCallback: function (chart) {
                        const legendContainer =
                            chart.canvas.parentElement.parentElement.querySelector(
                        ...
                        for (let i = 0; i < chart.data.datasets.length; i++) {
                            ...
                            var total = chart.data.datasets[i].data.reduce(
                                function (total, num) {
                                    return total + num;
                                }
                            );
                            itemClone.querySelector(".text").innerHTML =
                                chart.data.datasets[
                                    i
                                ].label.toLocaleUpperCase();
                ...
                options: {
                    ...
                    legendCallback: function (chart) {
                        ...
                        for (
                            ...
                            var itemClone = legendItem.content.cloneNode(true);
                            itemClone.querySelector(".text").innerHTML =
                                chart.data.labels[i].toLocaleUpperCase();
