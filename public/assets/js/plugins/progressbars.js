...
class ProgressBars {
    ...
    _initProgressLine() {
        ...
        if (document.querySelector("#progressLineAnimated")) {
            new ProgressBar.Line(
                document.querySelector("#progressLineAnimated"),
                {
                    color: Globals.primary,
                    trailColor: Globals.separator,
                    val: 75,
        ...
        if (document.querySelector("#progressLinePercent")) {
            new ProgressBar.Line(
                document.querySelector("#progressLinePercent"),
                {
                    color: Globals.primary,
                    trailColor: Globals.separator,
                    val: 75,
    ...
    _initProgressCircle() {
        if (document.querySelector("#progressCircleBasic")) {
            new ProgressBar.Circle(
                document.querySelector("#progressCircleBasic"),
                {
                    color: Globals.primary,
                    trailColor: Globals.separator,
                    val: 75,
        ...
        if (document.querySelector("#progressCirclePercent")) {
            new ProgressBar.Circle(
                document.querySelector("#progressCirclePercent"),
                {
                    color: Globals.primary,
                    trailColor: Globals.separator,
                    val: 75,
        ...
        if (document.querySelector("#progressCircleValue")) {
            new ProgressBar.Circle(
                document.querySelector("#progressCircleValue"),
                {
                    color: Globals.primary,
                    trailColor: Globals.separator,
                    val: 15,
    ...
    _initProgressSquare() {
        if (document.querySelector("#progressSquareBasic")) {
            new ProgressBar.Square(
                document.querySelector("#progressSquareBasic"),
                {
                    color: Globals.primary,
                    trailColor: Globals.separator,
                    val: 75,
        ...
        if (document.querySelector("#progressSquarePercent")) {
            new ProgressBar.Square(
                document.querySelector("#progressSquarePercent"),
                {
                    color: Globals.primary,
                    trailColor: Globals.separator,
                    val: 75,
        ...
        if (document.querySelector("#progressSquareValue")) {
            new ProgressBar.Square(
                document.querySelector("#progressSquareValue"),
                {
                    color: Globals.primary,
                    trailColor: Globals.separator,
                    val: 15,
