                    ...
                    <div class="d-flex justify-content-center card-header border-0 pb-0">
                        <ul class="nav nav-tabs nav-tabs-line card-header-tabs responsive-tabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#first" role="tab" type="button" aria-selected="true">Forum</button>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        var callback = function() {
            ...
            $("#inputGemini").val('');
            $(".card-content:last-of-type")[0].scrollIntoView();
            ajaxRequest('/chat/update', 'post', data);
        };
